...
PyConline AU's call for proposals (CFP) is open until **10 June, anywhere on earth**. There is a countdown on the submission page if you get lost navigating timezones. You can submit to the main conference and [specialist tracks](/program) through the same process.
