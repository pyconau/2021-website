...
Once curation is complete, we then start to notify speakers, allowing for speakers to decline if required, until we fill our entire conference schedule, including idenitifying several backup speakers. 
